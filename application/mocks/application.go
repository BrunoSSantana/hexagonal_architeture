...
import (
	...
	application "github.com/BrunoSSanta/hexagonal-go/application"
...
// MockProductPersistence is a mock of ProductPersistence interface.
type MockProductPersistence struct {
	ctrl     *gomock.Controller
	recorder *MockProductPersistenceMockRecorder
}

// MockProductPersistenceMockRecorder is the mock recorder for MockProductPersistence.
type MockProductPersistenceMockRecorder struct {
	mock *MockProductPersistence
}

// NewMockProductPersistence creates a new mock instance.
func NewMockProductPersistence(ctrl *gomock.Controller) *MockProductPersistence {
	mock := &MockProductPersistence{ctrl: ctrl}
	mock.recorder = &MockProductPersistenceMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockProductPersistence) EXPECT() *MockProductPersistenceMockRecorder {
	return m.recorder
}

// Get mocks base method.
func (m *MockProductPersistence) Get(id string) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(application.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Get indicates an expected call of Get.
func (mr *MockProductPersistenceMockRecorder) Get(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockProductPersistence)(nil).Get), id)
}

// Save mocks base method.
func (m *MockProductPersistence) Save(product application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", product)
	ret0, _ := ret[0].(application.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Save indicates an expected call of Save.
func (mr *MockProductPersistenceMockRecorder) Save(product interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockProductPersistence)(nil).Save), product)
}
